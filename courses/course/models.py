...
class Course(models.Model):
    ...
    contacts = models.OneToOneField(Contact, on_delete=models.CASCADE, related_name='contacts', null=True)
    branches = models.OneToOneField(Branch, on_delete=models.CASCADE, related_name='branches', null=True)
